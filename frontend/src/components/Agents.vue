          ...
          <div class="order-1 lg:order-2 space-y-4">
            ...
            >
              <div class="flex items-center gap-2 mb-4">
                ...
                <h4 class="font-bold">New Agent</h4>
              </div>
              <div class="space-y-3">
                ...
                <button
                  class="btn btn-primary btn-sm w-full rounded-lg mt-2"
            ...
            <div
              v-else
              class="rounded-2xl border border-success/30 bg-success/5 p-5 space-y-4 shadow-sm animate-in fade-in slide-in-from-bottom-2 duration-500"
            >
